package org.firstinspires.ftc.teamcode.Odometery;
...
public class OdometryCalibration extends LinearOpMode {
    ...
    String RFMotor = "RFMotor", RBMotor = "RBMotor", LFMotor = "LFMotor", LBMotor = "LBMotor";
    String verticalLeftEncoderName = RBMotor, verticalRightEncoderName = LFMotor, horizontalEncoderName = RFMotor;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initHardwareMap(RFMotor, RBMotor, LFMotor, LBMotor, verticalLeftEncoderName, verticalRightEncoderName, horizontalEncoderName);
