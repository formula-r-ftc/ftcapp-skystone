...
public class NewTwoStoneFoundationBlue extends OpMode{
    ...
    public void loop() {
        ...
        if (!MoveArmDown){
            ...
            trip5 = tripLoopSideways(one*-0.85);
            if(trip5){
                t1.reset();
            }
        }
        //Second Skystone
            ...
            trip6 = tripLoop((one*moveBack2)-300);
            if (trip6){
                t6.reset();
            }
        }
            ...
            trip7 = tripLoopSideways(one*1.75);
            if (trip7){
                t8.reset();
            }
        }
            ...
            trip8 = tripLoopSideways(one* -0.85);
            if (trip8){
                t1.reset();
            }
        }
            ...
            trip9 = tripLoop(-one*moveForward2);
            if(trip9){
                t1.reset();
            }
        }
            ...
            trip10 = tripLoopSideways(one*1.75);
            if(trip10){
                t1.reset();
            }
        }
