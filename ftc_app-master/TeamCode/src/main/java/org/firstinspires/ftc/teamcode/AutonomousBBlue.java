...
public class AutonomousBBlue extends LinearOpMode {
    ...
    private void moveLeftCustom() {
        RFMotor.setPower(1.2*FORWARD_SPEED);
        LFMotor.setPower(-1.2*FORWARD_SPEED);
        RBMotor.setPower(-1.2*FORWARD_SPEED);
        LBMotor.setPower(1.2*FORWARD_SPEED);
    }

    private void moveRightCustom() {
        RFMotor.setPower(-0.8*FORWARD_SPEED);
        LFMotor.setPower(0.8*FORWARD_SPEED);
        RBMotor.setPower(FORWARD_SPEED);
        LBMotor.setPower(-FORWARD_SPEED);
    }
